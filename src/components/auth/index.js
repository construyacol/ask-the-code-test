      ...
      <div className="AuthComponent">
        ...
        <div className="AuthContainer">
            ...
            <div className="AuthTitle">
              <div className="AuthContT">
                <div className="textTitleToggle">
                  <div className="titleToggle" style={{transform:!homeScreen ? 'translateY(-35px)' : 'translateY(0)'}}>
                    ...
                    <div className="AuthNavTitle">
                      {
                        screen !== 'reset_pass' &&
                        <div className="iconContAuth" onClick={this.volver} ><NavArrow color="#0066aa" size={15}/></div>
                      }
          ...
          <div className="footerText">
            <p className="fuenteMuseo">© 2019 - 2021 Coinsenda.com Todos los derechos reservados</p>
          </div>
