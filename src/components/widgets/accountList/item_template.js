      ...
      <div className={`ItemTemplate contWalleins animate`}>
        ...
        >
          ...
          <div
            ...
            style={{
              height: `${
                props.currencies.length ? props.currencies.length : "1"
              }00%`,
              top: `-${props.currency.id - 1}00%`,
            }}
          >
            {props.currencies.map((currency) => {
              return (
                <div
                  className={`iconBank2Cont ${
                    props.currency.red === currency.red ? "ON" : ""
                  }`}
                  key={currency.id}
                >
