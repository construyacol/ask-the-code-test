...
export const BankPichincha = props => {
  ...
  return(
    <Icon {...props} viewBox="0 0 204 214">


      <image overflow="visible" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMwAAADVCAMAAAAsJe+TAAADAFBMVEUAAAD/9cT36FT/9cH/9rr/
