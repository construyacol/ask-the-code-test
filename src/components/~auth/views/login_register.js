      ...
      <form className={`AuthSwitchComponent ${childrenAnim} ${section}`}>
        {actionSuccess ? (
          <Fragment>
            <div
              className={`${
                actionSuccess ? "actionSuccessIcon" : "contIconRec"
              }`}
            >
          ...
          <Fragment>
            ...
            <div className="AuthInput">
              <div className="IconPrefix">
                <Auth
                  size={22}
                  color={`${
                    (section === "login" && loginValidate) ||
                    (section === "register" && registerValidate)
                      ? "green"
                      : pswrd_status === "bad"
                      ? "red"
                      : "#50667a"
              ...
              />
              <p
                className={`Authstatus ${forgot ? "visibles" : "inVisible"}`}
                onClick={forgot ? forgotPassword : null}
              >
                {passMsg}
              </p>
            </div>
            ...
            <div
              ...
              style={{ display: section === "login" ? "grid" : "none" }}
            >
              <p className="fuente">Inicia con: </p>{" "}
              <div className="socialAuthButton" onClick={socialAuth}>
                <GooglePlay size={25} color="white" />
              </div>
            </div>

            <div
              className="AuthInput"
              style={{ display: section === "register" ? "grid" : "none" }}
            >
              <div className="IconPrefix">
                <Auth
                  size={22}
        ...
        {!actionSuccess && (
          <p className="TextNav">
            ...
            <b
              ...
              onClick={
                loader ? null : section === "login" ? createAccount : signIn
              }
            >
