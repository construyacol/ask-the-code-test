        ...
        >
          ...
          )} />
          {
            !props.isAppLoaded ?
              ...
              :
              <>
                <Route exact path="/:primary_path" component={() =>(<AccountList isWalletsView data={props.wallets} />)} />
