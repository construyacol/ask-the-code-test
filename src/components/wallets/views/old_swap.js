...
class SwapView extends Component {
    ...
    init_state = async () => {
        ...
        this.props.action.getDefaultPair(current_wallet, local_currency, current_pair)
    ...
    finish_swap = async () => {
        ...
        let new_swap = await this.props.action.addNewSwap(current_wallet.id, pair_id, value)
        // console.log('!!!!!____________________________________________addNewSwap', new_swap)
        if (!new_swap) {
