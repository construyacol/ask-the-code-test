...
export default (props) => {
  return (
    <React.Fragment>
      ...
      <Col md={12}>
        <h4>
          Para depositar y recibir, ¿Cuánto es lo mínimo y máximo que puedo
          realizar por Efecty en una operación?
        </h4>
      ...
      <Col md={12}>
        ...
        <Table responsive bordered striped>
          ...
          <tbody>
            ...
            <tr>
              <td className="text-center">
                ${Number(100001).toLocaleString()} a $
                {Number(200000).toLocaleString()}
              </td>
              <td className="text-center">{Number(1.78).toLocaleString()}%</td>
            </tr>
            <tr>
              <td className="text-center">
                ${Number(200001).toLocaleString()} a $
                {Number(500000).toLocaleString()}
              </td>
              <td className="text-center">{Number(1.54).toLocaleString()}%</td>
            </tr>
            <tr>
              <td className="text-center">
                ${Number(500001).toLocaleString()} a $
            ...
            <tr>
              <td className="text-center">
                ${Number(1000001).toLocaleString()} a $
                {Number(3000000).toLocaleString()}
              </td>
