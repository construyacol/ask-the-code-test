...
const StatusDisclaimer = ({ withdrawAccount, className, withdrawProviders }) => {
    ...
    'Tu dinero tardará apróximadamente entre 60 y 180 minutos en verse reflejado en tu cuenta bancaria una vez que el envío sea aceptado.' : 
    'Tu dinero tardará hasta el siguiente día bancario hábil en verse reflejado en tu cuenta bancaria una vez que el envío sea aceptado, debido a que es una transacción ACH. '
    ...
    'Los envío realizados en horario hábil, podrán reclamarse  3 horas después en cualquier punto Efecty habilitado del país, los que sean realizados por fuera de este horario, podrán reclamarse al siguiente día hábil después de las 10:00 AM.' :
    withdrawTimeMessage
