        ...
        
        {
          state[stageData?.key] &&
            <Disclaimer className="fullDisclaimer pending warning">
              ...
              <p className='fuente disclaimer--message_p disclaimer__open'>La cuenta de retiro debe estar vinculada a tu identidad, los envíos procesados hacia cuentas de terceros no podrán ser acréditados a la cuenta de destino.</p>
            </Disclaimer>
        }
